...
- (void)viewDidLoad
{
    ...
    if (pCoreHandle != nil)
    {
        ...
        //NSString* pFilePath =  (__bridge_transfer NSString *)CFURLCreateStringByAddingPercentEscapes( kCFAllocatorDefault, (__bridge_retained CFStringRef)[NSString stringWithFormat:@"file://%@/%@", [NSBundle mainBundle].bundlePath, @"Pandora/apps/MUI/www/list.html"], NULL, NULL,  kCFStringEncodingUTF8 );
         NSString* pFilePath =  (__bridge_transfer NSString *)CFURLCreateStringByAddingPercentEscapes( kCFAllocatorDefault, (__bridge_retained CFStringRef)[[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"Pandora/apps/MUI/www/login.html"], NULL, NULL,  kCFStringEncodingUTF8 );
