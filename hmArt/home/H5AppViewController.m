...
@implementation H5AppViewController
...
- (void)viewDidLoad
{
   ...
   // NSString* pWWWPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"Pandora/apps/HelloH5/www"];
    //NSString * pWWWPath= @"/Users/liuxue/Documents/workspace/51art/hmArt/Pandora/apps/HelloH5/www";
    //NSString * pWWWPath= @"Pandora/apps/HelloH5/www";
    
    // 如果路径中包含中文，或Xcode工程的targets名为中文则需要对路径进行编码
    
    NSString* pWWWPath =  (__bridge_transfer NSString *)CFURLCreateStringByAddingPercentEscapes( kCFAllocatorDefault, (__bridge_retained CFStringRef)[[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"Pandora/apps/MUI/www"], NULL, NULL,  kCFStringEncodingUTF8 );
