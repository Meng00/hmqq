...
@synthesize on, onText, offText, offTextWithOnColor;
...
- (void)setup
{
    ...
    self.toggleLayer.offTextWithOnColor = NO;
...
- (void)setOffTextWithOnColor:(BOOL)anOffTextWithOnColor
{
    if (offTextWithOnColor != anOffTextWithOnColor) {
        self.toggleLayer.offTextWithOnColor = anOffTextWithOnColor;
        [self.toggleLayer setNeedsDisplay];
    }
}
