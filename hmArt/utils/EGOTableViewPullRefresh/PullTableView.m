...
@synthesize disableRefreshing = _disableRefreshing;
@synthesize disableLoadingMore = _disableLoadingMore;
...
- (void)setDisableRefreshing:(BOOL)disableRefreshing
{
    _disableRefreshing = disableRefreshing;
...
- (void)setDisableLoadingMore:(BOOL)disableLoadingMore
{
    _disableLoadingMore = disableLoadingMore;
...
- (void)setRefreshingText:(NSString *)text forState:(EGOPullState)state
{
    if (refreshView)
        [refreshView setStatusText:text forStatus:state];
}

- (void)setLoadingMoreText:(NSString *)text forState:(EGOPullState)state
{
    if (loadMoreView)
        [loadMoreView setStatusText:text forStatus:state];
}
